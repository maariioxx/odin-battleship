...
`, "",{"version":3,"sources":["webpack://./src/styles.css"],"names":[],"mappings":"AAEA;EACE,gBAAgB;AAClB;AACA;EACE,gDAAgD;EAChD,aAAa;EACb,SAAS;EACT;;;;GAIC;EACD,iBAAiB;AACnB;;AAEA;EACE,eAAe;EACf,sBAAsB;EACtB,kBAAkB;EAClB,sBAAsB;AACxB;;AAEA;EACE,aAAa;EACb,uBAAuB;EACvB,qBAAqB;EACrB,UAAU;AACZ;;AAEA;;EAEE,aAAa;EACb,gDAAgD;EAChD,YAAY;AACd;;AAEA;EACE,yBAAyB;AAC3B;;AAEA;EACE,kBAAkB;EAClB,iBAAiB;AACnB;;AAEA;EACE,iBAAiB;EACjB,aAAa;EACb,uBAAuB;EACvB,gBAAgB;EAChB,iBAAiB;EACjB,QAAQ;EACR,YAAY;AACd;AACA;EACE,WAAW;EACX,YAAY;EACZ,kBAAkB;EAClB,UAAU;EACV,SAAS;AACX;;AAEA;EACE,gBAAgB;EAChB,qBAAqB;EACrB,kBAAkB;AACpB","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Montserrat:wght@300&family=Poppins:wght@300&display=swap');\r\n\r\n:root {\r\n  font-size: 62.5%;\r\n}\r\nbody {\r\n  font-family: 'Poppins', 'Montserrat', sans-serif;\r\n  height: 100vh;\r\n  margin: 0;\r\n  background: linear-gradient(\r\n    120deg,\r\n    rgba(47, 47, 47, 1) 1%,\r\n    rgba(23, 23, 23, 1) 50%\r\n  );\r\n  color: whitesmoke;\r\n}\r\n\r\nheader {\r\n  font-size: 7rem;\r\n  justify-self: baseline;\r\n  text-align: center;\r\n  margin: 10px 0 150px 0;\r\n}\r\n\r\n.container {\r\n  display: flex;\r\n  justify-content: center;\r\n  align-items: baseline;\r\n  gap: 15rem;\r\n}\r\n\r\n.grid,\r\n.aigrid {\r\n  display: grid;\r\n  grid-template: repeat(10, 1fr) / repeat(10, 1fr);\r\n  width: 400px;\r\n}\r\n\r\n.cell {\r\n  background-color: #161616;\r\n}\r\n\r\np {\r\n  text-align: center;\r\n  font-size: 1.5rem;\r\n}\r\n\r\nfooter {\r\n  font-size: 1.5rem;\r\n  display: flex;\r\n  justify-content: center;\r\n  align-items: end;\r\n  margin-top: 150px;\r\n  gap: 5px;\r\n  color: white;\r\n}\r\n#github-logo {\r\n  width: 30px;\r\n  height: 30px;\r\n  position: absolute;\r\n  left: 75px;\r\n  top: -5px;\r\n}\r\n\r\na {\r\n  color: lightblue;\r\n  text-decoration: none;\r\n  position: relative;\r\n}\r\n"],"sourceRoot":""}]);
// Exports
...
/* harmony export */   startGameText: () => (/* binding */ startGameText)
/* harmony export */ });
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var lodash_isEqual_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash/isEqual.js */ "./node_modules/lodash/isEqual.js");
...
class AI extends _player_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  checkHits(enemy) {
    ...
    for (const ship of this.gameboard.ships) {
      for (const c of ship.coordinates) {
        for (const coordinate of coordinates) {
          if (lodash_isEqual_js__WEBPACK_IMPORTED_MODULE_0__(coordinate, c)) equal = true;
        }
      }
    }
    if (!equal) {
      this.gameboard.placeShip(new _ship_js__WEBPACK_IMPORTED_MODULE_1__["default"](length), x, y, d);
      return true;
    }
  }
    ...
    while (!attacked) {
      ...
      if (hits.length > 0) {
        for (const hit of hits) {
          if (lodash_isEqual_js__WEBPACK_IMPORTED_MODULE_0__(hit, [x, y])) {
            equal = true;
          }
        }
      }
  ...
  checkShipList(x, y) {
    ...
    Object.values(this.ships).forEach((value) => {
      value.coordinates.forEach((c) => {
        if (lodash_isEqual_js__WEBPACK_IMPORTED_MODULE_0__(c, [x, y])) equal = value.ship;
      });
    });
    return equal;
  }
    ...
    if (d === 'v') {
      ...
      cell.addEventListener('click', () => {
        this.gameboard.placeShip(
          new _ship_js__WEBPACK_IMPORTED_MODULE_1__["default"](length),
...
(0,_DOM_js__WEBPACK_IMPORTED_MODULE_3__.createGrid)('player');
(0,_DOM_js__WEBPACK_IMPORTED_MODULE_3__.createGrid)('AI');

const Game = () => {
  const player = new _player_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
  const ai = new _ai_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
  let direction = 'v';
  ...
  function AIplays() {
    ...
    (0,_DOM_js__WEBPACK_IMPORTED_MODULE_3__.displayShips)(playercells, player.gameboard.grid, false);
    if (player.gameboard.checkIfAllShipsSunked()) (0,_DOM_js__WEBPACK_IMPORTED_MODULE_3__.showWinner)('AI');
    // MODAL
  }
    ...
    cell.addEventListener('mouseover', () => {
      switch (player.gameboard.ships.length) {
        ...
        case 4:
          ...
          break;
        default:
          (0,_DOM_js__WEBPACK_IMPORTED_MODULE_3__.startGameText)();
          break;
      }
    });
  });
    ...
    cell.addEventListener(
      ...
      () => {
        if (
          ...
          (0,_DOM_js__WEBPACK_IMPORTED_MODULE_3__.displayShips)(aicells, ai.gameboard.grid, true);
          if (ai.gameboard.checkIfAllShipsSunked()) (0,_DOM_js__WEBPACK_IMPORTED_MODULE_3__.showWinner)('Player');
          // MODAL
          AIplays();
        }
      },
